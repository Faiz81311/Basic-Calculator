...
button_9=Button(root,text="9",padx=40,pady=20, command=lambda: button_click(8))
button_0=Button(root,text="0",padx=40,pady=20, command=lambda: button_click(0))
button_add=Button(root,text="+",padx=39,pady=20, command=button_add)
button_sub=Button(root,text="-",padx=41,pady=20)
button_div=Button(root,text="/",padx=41,pady=20)
button_mul=Button(root,text="*",padx=41,pady=20)
button_equal=Button(root,text="=",padx=86,pady=22, command=button_equal)
